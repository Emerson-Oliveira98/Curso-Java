...
public class IFrmCadPizzas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        CbTamanho.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione algum tamanho", "Grande", "Média", "Brotinho" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtTempo, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                for (int i2 = 0; i2 < tblIngredientes.getRowCount(); i2++) {
                    if (i != i2) {
                        if (tblIngredientes.getValueAt(i, 0).toString().equals(tblIngredientes.getValueAt(i2, 0).toString())) {
                            ...
                            btnAddIngredientes.setEnabled(true);
                        }
                    }
                }
            }
...
if(op==JFileChooser.APPROVE_OPTION){
    ...
    if(verifica.equals(".jpg")||verifica.equals(".png")){
