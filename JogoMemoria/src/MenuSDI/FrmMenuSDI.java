 ...
 * @author lab
 */
public class FrmMenuSDI extends javax.swing.JFrame {

    /**
     * Creates new form FrmMenuSDI
     */
    public FrmMenuSDI() {
        initComponents();
    }
...
new DFrmEx2 (null,rootPaneCheckingEnabled).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMenuSDI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMenuSDI().setVisible(true);
            }
        });
    }
